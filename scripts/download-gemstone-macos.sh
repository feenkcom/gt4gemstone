...
then
	wget http://downloads.gemtalksystems.com/pub/GemStone64/3.7.0-Alpha6/GemStone64Bit3.7.0-i386.Darwin.dmg
fi

if [ ! -f GemStoneClientLibs3.7.0-i386.Darwin.dmg ]
then
	wget http://downloads.gemtalksystems.com/pub/GemStone64/3.7.0-Alpha6/GemStoneClientLibs3.7.0-i386.Darwin.dmg
fi
