...
then
	...
	wget http://downloads.gemtalksystems.com/pub/GemStone64/3.7.0/GemStone64Bit3.7.0-x86_64.Linux.zip
fi

if [ ! -f GemStoneClientLibs3.7.0-x86_64.Linux.zip ]
then
	echo "Downloading GS Libs to `pwd`"
	wget http://downloads.gemtalksystems.com/pub/GemStone64/3.7.0/GemStoneClientLibs3.7.0-x86_64.Linux.zip
fi
